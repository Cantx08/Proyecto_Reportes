        ...
        <div className="flex items-center justify-between px-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              {searchTerm && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary-100 text-primary-800 text-xs font-medium rounded-full">
              ...
              {selectedFaculty !== 'all' && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-secondary-100 text-secondary-800 text-xs font-medium rounded-full">
                  Facultad
                  <button onClick={() => setSelectedFaculty('all')} className="hover:bg-secondary-200 rounded-full p-0.5">
                    <X className="h-3 w-3" />
                  </button>
                </span>
              )}
              {selectedDepartment !== 'all' && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-info-100 text-info-800 text-xs font-medium rounded-full">
                  Departamento
          ...
          <div className="bg-neutral-50 px-6 py-4 border-t border-neutral-200">
            <div className="flex items-center justify-between">
              <div className="text-sm text-neutral-700">
                ...
                <span className="font-medium text-primary-600">{Math.min(endIndex, filteredAuthors.length)}</span> de{' '}
                <span className="font-medium text-primary-600">{filteredAuthors.length}</span> resultados
              </div>
