  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#042a53]"></div>
        <span className="ml-2">Cargando autores...</span>
      </div>
    );
  }
      ...
      <div className=\"bg-white rounded-lg shadow-sm border border-gray-200 mb-6\">
        <div className=\"px-6 py-4 flex items-center justify-between\">
          <div className=\"flex items-center\">
            <Users className=\"h-6 w-6 text-[#042a53] mr-3\" />
        ...
        <div className=\"p-4\">
          <div className=\"relative\">
            ...
            <input
              ...
              className=\"w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#042a53] focus:border-transparent\"
            />
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className=\"p-6\">
            <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
              <div>
                ...
                <input
                  ...
                  className=\"w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#042a53] focus:border-transparent disabled:bg-gray-100\"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className=\"w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#042a53] focus:border-transparent\"
                />
              </div>
            ...
            <div className=\"flex justify-end space-x-4 mt-6\">
              ...
              <button
                ...
                className=\"bg-[#042a53] text-white px-4 py-2 rounded-lg hover:bg-[#063870] disabled:opacity-50\"
              >
      ...
      <div className=\"bg-white rounded-lg shadow-sm border border-gray-200\">
        ...
        <div className=\"divide-y divide-gray-200\">
          {filteredAuthors.map((author) => (
            <div key={author.author_id} className=\"p-6 hover:bg-gray-50\">
              <div className=\"flex items-center justify-between\">
                <div className=\"flex-1\">
                  <div className=\"flex items-center mb-2\">
                    ...
                    <span className=\"ml-3 px-2 py-1 bg-gray-100 text-gray-800 text-sm rounded\">
                      ID: {author.author_id}
                    </span>
                  </div>
                ...
                <div className=\"flex items-center space-x-2 ml-4\">
                  <button
                    ...
                    className=\"p-2 text-gray-400 hover:text-[#042a53] hover:bg-gray-100 rounded\"
                  >
                  ...
                  <button
                    ...
                    disabled={deleting}
                    className=\"p-2 text-gray-400 hover:text-red-600 hover:bg-gray-100 rounded disabled:opacity-50\"
                  >
