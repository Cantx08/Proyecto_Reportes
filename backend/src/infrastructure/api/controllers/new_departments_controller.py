"""Controlador para la gestión de departamentos refactorizados."""

from typing import List
from fastapi import HTTPException, status

from ....application.services.department_service_new import DepartmentService
...
class NewDepartmentsController:
    """Controlador para operaciones CRUD de departamentos refactorizados."""
    ...
    async def get_department(self, dep_id: str) -> DepartmentResponseDTO:
        ...
        try:
            department = await self.department_service.get_department(dep_id)
            if not department:
                raise HTTPException(
    ...
    async def update_department(self, dep_id: str, department_data: DepartmentUpdateDTO) -> DepartmentResponseDTO:
        ...
        try:
            ...
            existing_department = await self.department_service.get_department(dep_id)
