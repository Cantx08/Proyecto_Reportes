...
from ...application.dtos.legacy_department_dto import LegacyDepartmentDTO
...
class DepartmentsFileRepository:
    ...
    def get_all_departments(self) -> List[LegacyDepartmentDTO]:
        """
        ...
        try:
            ...
            for _, row in df.iterrows():
                department = LegacyDepartmentDTO(
                    sigla=row['DEP_SIGLA'],
                    nombre=row['NOMBRE'],
